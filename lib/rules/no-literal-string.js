...
function sleep(dalayMillisecond) {
...
function autoTranslate(zhCnText, i18nFilePath) {
  ...
  const filePathList = langList.map(lang => path.resolve(i18nFilePath, `${lang}.json`)); 
  console.log('autoTranslate', zhCnText, i18nFilePath)
